...

{
  ...
  private_key: newSecret('private_key').getFrom(path='infra/ci/agent/githubapp', name='private-key'),
  app_id: newSecret('app_id').getFrom(path='infra/ci/agent/githubapp', name='app-id'),
  app_installation_id: newSecret('app_installation_id').getFrom(path='infra/ci/agent/githubapp', name='app-installation-id'),
