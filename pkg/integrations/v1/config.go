...
func (v *V1Integration) ActiveConfigs() []V1IntegrationConfig {
	activeConfigs := make([]V1IntegrationConfig, 0)
...
type Agent struct {
	...
	config.Common `yaml:",omitempty,inline"`
}
...
func (c *Agent) Cmn() config.Common {
	return c.Common
}
...
func (c *Cadvisor) Cmn() config.Common {
	return c.Common
}
...
func (c *ConsulExporter) Cmn() config.Common {
	return c.Common
}
...
func (c *DnsmasqExporter) Cmn() config.Common {
	return c.Common
}
...
func (c *ElasticsearchExporter) Cmn() config.Common {
	return c.Common
}
...
func (c *GithubExporter) Cmn() config.Common {
	return c.Common
}
...
func (c *KafkaExporter) Cmn() config.Common {
	return c.Common
}
...
func (c *MemcachedExporter) Cmn() config.Common {
	return c.Common
}
...
func (c *MongodbExporter) Cmn() config.Common {
	return c.Common
}
...
func (c *MysqldExporter) Cmn() config.Common {
	return c.Common
}
...
func (c *NodeExporter) Cmn() config.Common {
	return c.Common
}
...
func (c *PostgresExporter) Cmn() config.Common {
	return c.Common
}
...
func (c *ProcessExporter) Cmn() config.Common {
	return c.Common
}
...
func (c *RedisExporter) Cmn() config.Common {
	return c.Common
}
...
func (c *StatsdExporter) Cmn() config.Common {
	return c.Common
}
...
func (c *WindowsExporter) Cmn() config.Common {
	return c.Common
}
