...
type Flow struct {
	// The root instance of Flow. This will be nil if the instance of Flow is the
	// root. A non-root instance of Flow is generated by instantiating a module.
	rootController *Flow
...
func New(o Options) *Flow {
	return newController(nil, o)
}

func newController(rootController *Flow, o Options) *Flow {
	var (
		log       = o.Logger
		tracer    = o.Tracer
	...
	f.loader = controller.NewLoader(controller.ComponentGlobals{
		Logger:        log,
		...
		NewModuleController: func(id string) component.ModuleController {
			return newModuleController(rootController, &moduleControllerOptions{
				Logger:         log,
				Tracer:         tracer,
				Clusterer:      clusterer,
				Reg:            o.Reg,
