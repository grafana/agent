...
func (c *Component) Update(args component.Arguments) error {
	...
	targets := make([]scrape.Target, 0, len(newArgs.Targets))
...
func componentMapToPromLabels(ls scrape.Target) labels.Labels {
...
func promLabelsToComponent(ls labels.Labels) scrape.Target {
