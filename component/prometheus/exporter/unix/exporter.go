...
// This code is copied from ../exporter.go. This is used for specific logic
//  in modules temporarily while prometheus.exporter.unix is a singleton. This
//  package should go back to using ../exporter.go as soon as it is not a singleton
//  and the limitation can be removed from modules.
