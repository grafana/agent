...
func TestAddingMarker(t *testing.T) {
	...
	globalID := mapping.getGlobalRefIDByLabels(fm.labels)
	shouldBeSameGlobalID := mapping.getGlobalRefIDByLabels(fm.labels)
...
func TestAddingDifferentMarkers(t *testing.T) {
	...
	globalID := mapping.getGlobalRefIDByLabels(fm.labels)
	shouldBeDifferentID := mapping.getGlobalRefIDByLabels(fm2.labels)
