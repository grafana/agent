...
func Test_parseMessage_function_app(t *testing.T) {
	...
	assert.Equal(t, expectedLine2, removeCRLFIfWindows(entries[1].Line))
...
func Test_parseMessage_custom_payload_text(t *testing.T) {
	...
	assert.Equal(t, expectedLine, removeCRLFIfWindows(entries[0].Line))
...
func Test_parseMessage_custom_payload_json_with_records_array(t *testing.T) {
	...
	assert.Equal(t, expectedLine1, removeCRLFIfWindows(entries[0].Line))
	assert.Equal(t, expectedLine2, removeCRLFIfWindows(entries[1].Line))
	assert.Equal(t, expectedLine3, removeCRLFIfWindows(entries[2].Line))
...
// removeCRLFIfWindows removes the \r during string comparison
func removeCRLFIfWindows(s string) string {
