...
func init() {
	component.Register(component.Registration{
		Name:    "integrations.v2.autoscrape",
		Args:    Arguments{},
		Exports: Exports{},
...
type Arguments struct {
	...
	relabelConfigs       []*relabel.Config `river:"relabel_config,block,optional"`
	metricRelabelConfigs []*relabel.Config `river:"metric_relabel_config,block,optional"`
}

type Exports struct {
	Config internal.Config `river:"config,attr"`
}
...
func (args *Arguments) toInternalConfig() internal.Config {
	return internal.Config{
		...
		RelabelConfigs:       relabel.ComponentToPromRelabelConfigs(args.relabelConfigs),
		MetricRelabelConfigs: relabel.ComponentToPromRelabelConfigs(args.metricRelabelConfigs),
	}
}
