module github.com/grafana/agent/component/otelcol/processor/estimator/gcpricingestimatorprocessor

go 1.20

require go.opentelemetry.io/collector/consumer v0.73.0
