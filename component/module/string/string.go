...
func New(o component.Options, args Arguments) (component.Component, error) {
	...
	c.flw = flow.New(flow.Options{
		...
		HealthMetrics:  c.opts.HealthMetrics,
	})
	return c, nil
}
...
func (c *Component) Update(args component.Arguments) error {
	...
	if c.args.Content != newArgs.Content || !c.loadedOnce {
		f, err := flow.ReadFile(c.opts.ID, []byte(c.args.Content))
		if err != nil {
			return err
		}
		c.components, err = c.flw.LoadFile(f)
		if err != nil {
			return err
		}
