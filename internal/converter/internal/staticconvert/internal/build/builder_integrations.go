...
import (
	...
	int_config "github.com/grafana/agent/static/integrations/config"
	...
	"github.com/grafana/agent/static/integrations/mongodb_exporter"
	mssql_exporter "github.com/grafana/agent/static/integrations/mssql"
	"github.com/grafana/agent/static/integrations/mysqld_exporter"
	...
	"github.com/grafana/agent/static/integrations/redis_exporter"
	"github.com/grafana/agent/static/integrations/snmp_exporter"
	"github.com/grafana/agent/static/integrations/snowflake_exporter"
	...
	apache_exporter_v2 "github.com/grafana/agent/static/integrations/v2/apache_http"
	app_agent_receiver_v2 "github.com/grafana/agent/static/integrations/v2/app_agent_receiver"
	blackbox_exporter_v2 "github.com/grafana/agent/static/integrations/v2/blackbox_exporter"
	common_v2 "github.com/grafana/agent/static/integrations/v2/common"
	eventhandler_v2 "github.com/grafana/agent/static/integrations/v2/eventhandler"
	metricsutils_v2 "github.com/grafana/agent/static/integrations/v2/metricsutils"
	snmp_exporter_v2 "github.com/grafana/agent/static/integrations/v2/snmp_exporter"
	vmware_exporter_v2 "github.com/grafana/agent/static/integrations/v2/vmware_exporter"
