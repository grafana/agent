...
* `__meta_scaleway_baremetal_os_version`: Operating system version of the server.
...
- _`<SCALEWAY_PROJECT_ROLE>`_: Set to `baremetal` to discover [baremetal][] machines or `instance` to discover [virtual instances][instance].
