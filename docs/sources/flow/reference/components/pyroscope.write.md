...
- Components that consume [Pyroscope `ProfilesReceiver`](https://grafana.com/docs/agent/<AGENT_VERSION>/flow/reference/compatibility#pyroscope-profilesreceiver-consumers)
