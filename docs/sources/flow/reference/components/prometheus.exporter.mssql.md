...
``The `connection_string` argument`` should be in the [format](https://github.com/burningalchemist/sql_exporter/blob/master/examples/azure-sql-mi/sql_exporter.yml#L21):
```conn
