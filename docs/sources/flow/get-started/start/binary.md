---
aliases:
   - /docs/grafana-cloud/agent/flow/get-started/start/binary/
   - /docs/grafana-cloud/monitor-infrastructure/agent/flow/get-started/start/binary/
   - /docs/grafana-cloud/monitor-infrastructure/integrations/agent/flow/get-started/start/binary/
   - /docs/grafana-cloud/send-data/agent/flow/get-started/start/binary/
canonical: https://grafana.com/docs/agent/latest/flow/get-started/start/binary/
...
[StartLinux]: "/docs/agent/ -> /docs/agent/<AGENT_VERSION>/flow/get-started/start/linux.md"
[StartLinux]: "/docs/grafana-cloud/ -> /docs/grafana-cloud/send-data/agent/flow/flow/get-started/start/linux.md"
{{% /docs/reference %}}
