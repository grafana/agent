...
> If you don't pass this argument, the [debugging UI][] won't be available outside of the Docker container.
...
{{% docs/reference %}}
[debugging UI]: "/docs/agent/ -> /docs/agent/<AGENT_VERSION>/flow/monitoring/debugging.md#grafana-agent-flow-ui"
[debugging UI]: "/docs/grafana-cloud/ -> /docs/grafana-cloud/monitor-infrastructure/agent/flow/monitoring/debugging.md#grafana-agent-flow-ui"
