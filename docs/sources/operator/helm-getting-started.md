...
- The `kubectl` command-line client [installed](https://kubernetes.io/docs/tasks/tools/#kubectl) and configured on your machine
- The `helm` command-line client [installed](https://helm.sh/docs/intro/install/) and configured on your machine
