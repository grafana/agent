...
// DumpMaps dumps the set of metric maps that will be used to collect metrics.
...
func DisableSettingsMetrics(b bool) Opt {
	return func(e *Exporter) {
...
func AutoDiscoverDatabases(b bool) Opt {
	return func(e *Exporter) {
...
func ExcludeDatabases(s string) Opt {
	return func(e *Exporter) {
...
func WithUserQueriesPath(p string) Opt {
	return func(e *Exporter) {
		e.userQueriesPath = p
	}
}
...
func WithConstantLabels(s string) Opt {
	return func(e *Exporter) {
...
// GetDataSources tries to get the DSN.
...
func NewExporter(dsn []string, opts ...Opt) *Exporter {
	e := &Exporter{
		dsn:               dsn,
