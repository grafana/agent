...
// ADFSConfig configures and instantiates a new adfs collector.
type ADFSConfig struct{}

// Name implements Config.
func (c *ADFSConfig) Name() string { return "adfs" }

// RegisterFlags implements Config.
func (c *ADFSConfig) RegisterFlags(ka *kingpin.Application) {}

// Build implements Config.
func (c *ADFSConfig) Build() (Collector, error) { return newADFSCollector() }
...
func (c *adfsCollector) PerfCounterNames() []string { return []string{"AD FS"} }
