...
// SystemConfig configures and instantiates a new system collector.
...
func (c *SystemConfig) RegisterFlags(ka *kingpin.Application) {}

// Build implements Config.
func (c *SystemConfig) Build() (Collector, error) { return NewSystemCollector() }
...
func (c *SystemCollector) PerfCounterNames() []string { return []string{"System"} }
