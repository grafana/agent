...
// NETFramework_NETCLRLoadingConfig configures and instantiates a new netframework_clrloading collector.
type NETFramework_NETCLRLoadingConfig struct{}

// Name implements Config.
func (c *NETFramework_NETCLRLoadingConfig) Name() string { return "netframework_clrloading" }

// RegisterFlags implements Config.
func (c *NETFramework_NETCLRLoadingConfig) RegisterFlags(ka *kingpin.Application) {}

// Build implements Config.
func (c *NETFramework_NETCLRLoadingConfig) Build() (Collector, error) {
...
func (c *NETFramework_NETCLRLoadingCollector) PerfCounterNames() []string { return nil }
