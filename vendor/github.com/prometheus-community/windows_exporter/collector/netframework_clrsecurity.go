...
// NETFramework_NETCLRSecurityConfig configures and instantiates a new netframework_clrsecurity collector.
type NETFramework_NETCLRSecurityConfig struct{}

// Name implements Config.
func (c *NETFramework_NETCLRSecurityConfig) Name() string { return "netframework_clrsecurity" }

// RegisterFlags implements Config.
func (c *NETFramework_NETCLRSecurityConfig) RegisterFlags(ka *kingpin.Application) {}

// Build implements Config.
func (c *NETFramework_NETCLRSecurityConfig) Build() (Collector, error) {
...
func (c *NETFramework_NETCLRSecurityCollector) PerfCounterNames() []string { return nil }
