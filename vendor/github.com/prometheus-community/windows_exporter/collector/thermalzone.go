...
// ThermalZoneConfig configures and instantiates a new thermalzone collector.
type ThermalZoneConfig struct{}

// Name implements Config.
func (c *ThermalZoneConfig) Name() string { return "thermalzone" }

// RegisterFlags implements Config.
func (c *ThermalZoneConfig) RegisterFlags(ka *kingpin.Application) {}

// Build implements Config.
func (c *ThermalZoneConfig) Build() (Collector, error) { return NewThermalZoneCollector() }
...
func (c *thermalZoneCollector) PerfCounterNames() []string { return nil }
