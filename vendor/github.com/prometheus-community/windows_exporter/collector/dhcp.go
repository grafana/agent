...
// DHCPConfig configures and instantiates a new dhcp collector.
type DHCPConfig struct{}

// Name implements Config.
func (c *DHCPConfig) Name() string { return "dhcp" }

// RegisterFlags implements Config.
func (c *DHCPConfig) RegisterFlags(ka *kingpin.Application) {}

// Build implements Config.
func (c *DHCPConfig) Build() (Collector, error) { return NewDhcpCollector() }
...
func (c *DhcpCollector) PerfCounterNames() []string {
