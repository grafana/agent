...
// ServiceConfig configures and instantiates a new service collector.
type ServiceConfig struct {
	WhereClause string
}

// Name implements Config.
func (c *ServiceConfig) Name() string { return "service" }

// RegisterFlags implements Config.
func (c *ServiceConfig) RegisterFlags(ka *kingpin.Application) {
	ka.Flag(
		"collector.service.services-where",
		"WQL 'where' clause to use in WMI metrics query. Limits the response to the services you specify and reduces the size of the response.",
	).Default("").StringVar(&c.WhereClause)
}

// Build implements Config.
func (c *ServiceConfig) Build() (Collector, error) { return NewserviceCollector(c) }
...
// NewserviceCollector ...
func NewserviceCollector(c *ServiceConfig) (Collector, error) {
	...
	return &serviceCollector{
		...
		queryWhereClause: c.WhereClause,
	}, nil
}

// PerfCounterNames implements Collector.
func (c *serviceCollector) PerfCounterNames() []string { return nil }
