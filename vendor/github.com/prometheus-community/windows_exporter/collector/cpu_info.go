...
// CpuInfoConfig configures and instantiates a new cpu_info collector.
type CpuInfoConfig struct{}

// Name implements Config.
func (c *CpuInfoConfig) Name() string { return "cpu_info" }

// RegisterFlags implements Config.
func (c *CpuInfoConfig) RegisterFlags(ka *kingpin.Application) {}

// Build implements Config.
func (c *CpuInfoConfig) Build() (Collector, error) { return newCpuInfoCollector() }
...
func (c *CpuInfoCollector) PerfCounterNames() []string { return nil }
