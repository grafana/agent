...
// MemoryConfig configures and instantiates a new memory collector.
type MemoryConfig struct{}

// Name implements Config.
func (c *MemoryConfig) Name() string { return "memory" }

// RegisterFlags implements Config.
func (c *MemoryConfig) RegisterFlags(ka *kingpin.Application) {}

// Build implements Config.
func (c *MemoryConfig) Build() (Collector, error) { return NewMemoryCollector() }
...
func (c *MemoryCollector) PerfCounterNames() []string { return []string{"Memory"} }
