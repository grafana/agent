...
// MSMQConfig configures and instantiates a new msmq collector.
type MSMQConfig struct {
	WhereClause string
}

// Name implements Config.
func (c *MSMQConfig) Name() string { return "msmq" }

// RegisterFlags implements Config.
func (c *MSMQConfig) RegisterFlags(ka *kingpin.Application) {
	ka.Flag(
	...
	).StringVar(&c.WhereClause)
}

// Build implements Config.
func (c *MSMQConfig) Build() (Collector, error) { return NewMSMQCollector(c) }
...
func (c *Win32_PerfRawData_MSMQ_MSMQQueueCollector) PerfCounterNames() []string { return nil }
