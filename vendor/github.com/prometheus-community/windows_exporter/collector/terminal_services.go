...
// TerminalServicesConfig configures and instantiates a new terminal_services collector.
type TerminalServicesConfig struct{}

// Name implements Config.
func (c *TerminalServicesConfig) Name() string { return "terminal_services" }

// RegisterFlags implements Config.
func (c *TerminalServicesConfig) RegisterFlags(ka *kingpin.Application) {}

// Build implements Config.
func (c *TerminalServicesConfig) Build() (Collector, error) { return NewTerminalServicesCollector() }
...
func (c *TerminalServicesCollector) PerfCounterNames() []string {
