...
// NETFramework_NETCLRMemoryConfig configures and instantiates a new netframework_clrmemory collector.
type NETFramework_NETCLRMemoryConfig struct{}

// Name implements Config.
func (c *NETFramework_NETCLRMemoryConfig) Name() string { return "netframework_clrmemory" }

// RegisterFlags implements Config.
func (c *NETFramework_NETCLRMemoryConfig) RegisterFlags(ka *kingpin.Application) {}

// Build implements Config.
func (c *NETFramework_NETCLRMemoryConfig) Build() (Collector, error) {
...
func (c *NETFramework_NETCLRMemoryCollector) PerfCounterNames() []string { return nil }
