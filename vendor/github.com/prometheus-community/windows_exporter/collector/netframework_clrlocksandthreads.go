...
// NETFramework_NETCLRLocksAndThreadsConfig configures and instantiates a new netframework_clrlocksandthreads collector.
type NETFramework_NETCLRLocksAndThreadsConfig struct{}

// Name implements Config.
func (c *NETFramework_NETCLRLocksAndThreadsConfig) Name() string {
	return "netframework_clrlocksandthreads"
}

// RegisterFlags implements Config.
func (c *NETFramework_NETCLRLocksAndThreadsConfig) RegisterFlags(ka *kingpin.Application) {}

// Build implements Config.
func (c *NETFramework_NETCLRLocksAndThreadsConfig) Build() (Collector, error) {
...
func (c *NETFramework_NETCLRLocksAndThreadsCollector) PerfCounterNames() []string { return nil }
