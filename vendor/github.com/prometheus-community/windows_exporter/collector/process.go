...
// ProcessConfig configures and instantiates a new process collector.
...
func (c *ProcessConfig) Name() string { return "process" }

// RegisterFlags implements Config.
func (c *ProcessConfig) RegisterFlags(ka *kingpin.Application) {
	ka.Flag(
...
func (c *ProcessConfig) Build() (Collector, error) { return newProcessCollector(c) }
...
// NewProcessCollector ...
func newProcessCollector(c *ProcessConfig) (Collector, error) {
	...
	return &processCollector{
		...
		processWhitelistPattern: regexp.MustCompile(fmt.Sprintf("^(?:%s)$", c.ProcessWhitelist)),
		processBlacklistPattern: regexp.MustCompile(fmt.Sprintf("^(?:%s)$", c.ProcessBlacklist)),
	}, nil
}
...
func (c *processCollector) PerfCounterNames() []string { return []string{"Process"} }
