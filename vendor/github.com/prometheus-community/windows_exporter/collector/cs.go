...
// CSConfig configures and instantiates a new cs collector.
type CSConfig struct{}

// Name implements Config.
func (c *CSConfig) Name() string { return "cs" }

// RegisterFlags implements Config.
func (c *CSConfig) RegisterFlags(ka *kingpin.Application) {}

// Build implements Config.
func (c *CSConfig) Build() (Collector, error) { return NewCSCollector() }
...
func (c *CSCollector) PerfCounterNames() []string { return nil }
