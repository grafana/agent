...
// NETFramework_NETCLRInteropConfig configures and instantiates a new netframework_clrinterop collector.
type NETFramework_NETCLRInteropConfig struct{}

// Name implements Config.
func (c *NETFramework_NETCLRInteropConfig) Name() string { return "netframework_clrinterop" }

// RegisterFlags implements Config.
func (c *NETFramework_NETCLRInteropConfig) RegisterFlags(ka *kingpin.Application) {}

// Build implements Config.
func (c *NETFramework_NETCLRInteropConfig) Build() (Collector, error) {
...
func (c *NETFramework_NETCLRInteropCollector) PerfCounterNames() []string { return nil }
