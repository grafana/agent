...
// TimeConfig configures and instantiates a new time collector.
type TimeConfig struct{}

// Name implements Config.
func (c *TimeConfig) Name() string { return "time" }

// RegisterFlags implements Config.
func (c *TimeConfig) RegisterFlags(ka *kingpin.Application) {}

// Build implements Config.
func (c *TimeConfig) Build() (Collector, error) { return newTimeCollector() }
...
func (c *TimeCollector) PerfCounterNames() []string { return []string{"Windows Time Service"} }
