...
// OSConfig configures and instantiates a new os collector.
type OSConfig struct{}

// Name implements Config.
func (c *OSConfig) Name() string { return "os" }

// RegisterFlags implements Config.
func (c *OSConfig) RegisterFlags(ka *kingpin.Application) {}

// Build implements Config.
func (c *OSConfig) Build() (Collector, error) { return NewOSCollector() }
...
func (c *OSCollector) PerfCounterNames() []string { return nil }
