...
// NETFramework_NETCLRExceptionsConfig configures and instantiates a new netframework_clrexceptions collector.
type NETFramework_NETCLRExceptionsConfig struct{}

// Name implements Config.
func (c *NETFramework_NETCLRExceptionsConfig) Name() string {
	return "netframework_clrexceptions"
}

// RegisterFlags implements Config.
func (c *NETFramework_NETCLRExceptionsConfig) RegisterFlags(ka *kingpin.Application) {}

// Build implements Config.
func (c *NETFramework_NETCLRExceptionsConfig) Build() (Collector, error) {
...
func (c *NETFramework_NETCLRExceptionsCollector) PerfCounterNames() []string { return nil }
