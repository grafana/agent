...
// NETFramework_NETCLRRemotingConfig configures and instantiates a new netframework_clrremoting collector.
type NETFramework_NETCLRRemotingConfig struct{}

// Name implements Config.
func (c *NETFramework_NETCLRRemotingConfig) Name() string { return "netframework_clrremoting" }

// RegisterFlags implements Config.
func (c *NETFramework_NETCLRRemotingConfig) RegisterFlags(ka *kingpin.Application) {}

// Build implements Config.
func (c *NETFramework_NETCLRRemotingConfig) Build() (Collector, error) {
...
func (c *NETFramework_NETCLRRemotingCollector) PerfCounterNames() []string { return nil }
