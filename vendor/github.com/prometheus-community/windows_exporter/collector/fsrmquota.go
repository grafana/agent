...
// FSRMQuotaConfig configures and instantiates a new fsrmquota collector.
type FSRMQuotaConfig struct{}

// Name implements Config.
func (c *FSRMQuotaConfig) Name() string { return "fsrmquota" }

// RegisterFlags implements Config.
func (c *FSRMQuotaConfig) RegisterFlags(ka *kingpin.Application) {}

// Build implements Config.
func (c *FSRMQuotaConfig) Build() (Collector, error) { return newFSRMQuotaCollector() }
...
func (c *FSRMQuotaCollector) PerfCounterNames() []string { return nil }
