...
// ADConfig configures and instantiates an ADCollector.
type ADConfig struct{}

// Name implements Config.
func (c *ADConfig) Name() string { return "ad" }

// RegisterFlags implements Config.
func (c *ADConfig) RegisterFlags(ka *kingpin.Application) {}

// Build implements Config.
func (c *ADConfig) Build() (Collector, error) { return NewADCollector() }
...
func (c *ADCollector) PerfCounterNames() []string { return nil }
