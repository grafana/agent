...
// TextFileConfig configures and instantiates a new textfile collector.
type TextFileConfig struct {
	Directory string
}

// Name implements Config.
func (c *TextFileConfig) Name() string { return "textfile" }

// RegisterFlags implements Config.
func (c *TextFileConfig) RegisterFlags(ka *kingpin.Application) {
	ka.Flag(
		"collector.textfile.directory",
		"Directory to read text files with metrics from.",
	).Default("C:\\Program Files\\windows_exporter\\textfile_inputs").StringVar(&c.Directory)
}

// Build implements Config.
func (c *TextFileConfig) Build() (Collector, error) { return NewTextFileCollector(c) }
...
func NewTextFileCollector(c *TextFileConfig) (Collector, error) {
...
func (c *textFileCollector) PerfCounterNames() []string { return nil }
