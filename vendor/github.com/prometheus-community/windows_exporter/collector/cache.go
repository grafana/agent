...
// CacheConfig configures and instantiates a cache collector.
type CacheConfig struct{}

// Name implements Config.
func (c *CacheConfig) Name() string { return "cache" }

// RegisterFlags implements Config.
func (c *CacheConfig) RegisterFlags(ka *kingpin.Application) {}

// Build implements Config.
func (c *CacheConfig) Build() (Collector, error) { return newCacheCollector() }
...
func (c *CacheCollector) PerfCounterNames() []string {
	return []string{"Cache"}
}
