...
// ContainerMetricsConfig configures and instantiates an container metrics collector.
type ContainerMetricsConfig struct{}

// Name implements Config.
func (c *ContainerMetricsConfig) Name() string { return "container" }

// RegisterFlags implements Config.
func (c *ContainerMetricsConfig) RegisterFlags(ka *kingpin.Application) {}

// Build implements Config.
func (c *ContainerMetricsConfig) Build() (Collector, error) {
...
func (c *ContainerMetricsCollector) PerfCounterNames() []string { return nil }
