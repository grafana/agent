...
// RemoteFxConfig configures and instantiates a new remote_fx collector.
type RemoteFxConfig struct{}

// Name implements Config.
func (c *RemoteFxConfig) Name() string { return "remote_fx" }

// RegisterFlags implements Config.
func (c *RemoteFxConfig) RegisterFlags(ka *kingpin.Application) {}

// Build implements Config.
func (c *RemoteFxConfig) Build() (Collector, error) { return NewRemoteFx() }
...
func (c *RemoteFxCollector) PerfCounterNames() []string {
