...
// LogonConfig configures and instantiates a new logon collector.
type LogonConfig struct{}

// Name implements Config.
func (c *LogonConfig) Name() string { return "logon" }

// RegisterFlags implements Config.
func (c *LogonConfig) RegisterFlags(ka *kingpin.Application) {}

// Build implements Config.
func (c *LogonConfig) Build() (Collector, error) { return NewLogonCollector() }
...
func (c *LogonCollector) PerfCounterNames() []string { return nil }
