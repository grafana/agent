...
// VmwareConfig configures and instantiates a new vmware collector.
type VmwareConfig struct{}

// Name implements Config.
func (c *VmwareConfig) Name() string { return "vmware" }

// RegisterFlags implements Config.
func (c *VmwareConfig) RegisterFlags(ka *kingpin.Application) {}

// Build implements Config.
func (c *VmwareConfig) Build() (Collector, error) { return NewVmwareCollector() }
...
func (c *VmwareCollector) PerfCounterNames() []string { return nil }
