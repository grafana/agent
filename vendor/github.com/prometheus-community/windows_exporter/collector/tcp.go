...
// TCPConfig configures and instantiates a new tcp collector.
type TCPConfig struct{}

// Name implements Config.
func (c *TCPConfig) Name() string { return "tcp" }

// RegisterFlags implements Config.
func (c *TCPConfig) RegisterFlags(ka *kingpin.Application) {}

// Build implements Config.
func (c *TCPConfig) Build() (Collector, error) { return NewTCPCollector() }
...
func (c *TCPCollector) PerfCounterNames() []string { return []string{"TCPv4", "TCPv6"} }
