...
// CPUConfig configures and instantiates a new cpu collector.
type CPUConfig struct{}

// Name implements Config.
func (c *CPUConfig) Name() string { return "cpu" }

// RegisterFlags implements Config.
func (c *CPUConfig) RegisterFlags(ka *kingpin.Application) {}

// Build implements Config.
func (c *CPUConfig) Build() (Collector, error) { return newCPUCollector() }
...
func (c *cpuCollectorBasic) PerfCounterNames() []string {
...
func (c *cpuCollectorFull) PerfCounterNames() []string {
