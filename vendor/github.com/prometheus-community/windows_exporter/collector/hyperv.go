...
// HyperVConfig configures and instantiates a new hyperv collector.
type HyperVConfig struct{}

// Name implements Config.
func (c *HyperVConfig) Name() string { return "hyperv" }

// RegisterFlags implements Config.
func (c *HyperVConfig) RegisterFlags(ka *kingpin.Application) {}

// Build implements Config.
func (c *HyperVConfig) Build() (Collector, error) { return NewHyperVCollector() }
...
func (c *HyperVCollector) PerfCounterNames() []string { return nil }
