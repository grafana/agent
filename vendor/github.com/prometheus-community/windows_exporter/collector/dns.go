...
// DNSConfig configures and instantiates a new dns collector.
type DNSConfig struct{}

// Name implements Config.
func (c *DNSConfig) Name() string { return "dns" }

// RegisterFlags implements Config.
func (c *DNSConfig) RegisterFlags(ka *kingpin.Application) {}

// Build implements Config.
func (c *DNSConfig) Build() (Collector, error) { return NewDNSCollector() }
...
func (c *DNSCollector) PerfCounterNames() []string { return nil }
