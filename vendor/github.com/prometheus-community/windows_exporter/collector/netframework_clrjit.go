...
// NETFramework_NETCLRJitConfig configures and instantiates a new netframework_clrjit collector.
type NETFramework_NETCLRJitConfig struct{}

// Name implements Config.
func (c *NETFramework_NETCLRJitConfig) Name() string { return "netframework_clrjit" }

// RegisterFlags implements Config.
func (c *NETFramework_NETCLRJitConfig) RegisterFlags(ka *kingpin.Application) {}

// Build implements Config.
func (c *NETFramework_NETCLRJitConfig) Build() (Collector, error) {
...
func (c *NETFramework_NETCLRJitCollector) PerfCounterNames() []string { return nil }
